#!/usr/bin/env python3
"""Thin HDF5-backed Dataset used by the training and evaluation scripts."""
...
class DeciferDataset(Dataset):
    """Expose tokenised CIF/XRD tensors via a PyTorch ``Dataset``."""
    ...
    def __init__(
        ...
        *,
        ...
        """Open the HDF5 file and cache dataset handles for later slices."""
    ...
    def __len__(self):
        """Return the total number of entries available in the dataset."""
        return self.dataset_length

    def __getitem__(self, idx):
        """Materialise tensors and strings for ``idx``."""
        data = {}
        for key in self.data_keys:
